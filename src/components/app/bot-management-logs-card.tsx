  ...
  return (
    <Card data-layout="botLogsRightColumn">
      ...
      <CardContent className="px-3 pb-3">
        <div className="mb-2 grid gap-2 rounded-md border border-border/70 px-2.5 py-2 text-xs text-muted-foreground md:grid-cols-2">
...
function StatusItem({ label, title, value }: { label: string; title?: string; value: string }) {
  return (
    <div className="min-w-0 break-all" title={title ?? value}>
