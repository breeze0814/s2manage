...
export function GroupsDashboard() {
  ...
  return (
    <section className="page-stack">
      <header className="page-header"><div><h1 className="page-heading">分组倍率</h1><p className="page-description">配置目标分组绑定、计算规则与应用状态</p></div><button type="button" onClick={view.refresh} disabled={view.loading} className="secondary-button shrink-0 self-start lg:self-auto">{view.loading ? <Loader2 className="size-3.5 animate-spin" /> : <RefreshCw className="size-3.5" />}刷新分组</button></header>
