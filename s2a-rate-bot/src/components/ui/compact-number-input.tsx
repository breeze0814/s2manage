...
export function CompactNumberInput({ value, onChange, suffix, width = "compact", tone = "default", ...input }: Readonly<NumberInputProps>) {
  ...
  return (
    <span className="flex min-h-10 w-full overflow-hidden rounded-lg border border-border-strong bg-surface transition-[border-color,box-shadow,background-color] duration-200 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 sm:w-fit">
